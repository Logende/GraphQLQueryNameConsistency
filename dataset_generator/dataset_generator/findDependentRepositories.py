...
# Copied from https://github.com/nvuillam/github-dependents-info and slightly adapted
class GithubDependentsInfo:
    ...
    def collect(self):
        ...
        # only take first two packages because those are apollo client. Others don't matter for our search
        self.packages = self.packages[0:2]
